...
public class Servidor{
	...
	public static void main(String[] args){
		...
		try {
			...
			MultisocketServer multi_server_1 = new MultisocketServer(multi_socket,target_ip, 10033, data1);
			MultisocketServer multi_server_2 = new MultisocketServer(multi_socket,target_ip, 10034, data2);
			MultisocketServer multi_server_3 = new MultisocketServer(multi_socket,target_ip, 10035, data3);
			SocketServer server_t = new SocketServer(datas);
